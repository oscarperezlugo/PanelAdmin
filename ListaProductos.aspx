<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListaProductos.aspx.cs" Inherits="PanelAdmin.ListaProductos" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">   
    <c><p><h2>CIFRAS DE PRODUCTOS</h2></p></c>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT [Producto], [Precio], [iDProducto], [PrecioD], [Categoria], [Cantidad], [Impuesto] FROM [Producto] ORDER BY [Cantidad] DESC"></asp:SqlDataSource>
</asp:Content>
