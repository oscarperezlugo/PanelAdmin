<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Delivery.aspx.cs" Inherits="PanelAdmin.Delivery" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <c><p><h2>PEDIDOS DELIVERY</h2></p></c>
...
<PagerStyle CssClass="pgr"></PagerStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT * FROM [Cabecera] WHERE ([TipoVenta] = @TipoVenta) ORDER BY [FechaVenta] DESC">
        <SelectParameters>
            <asp:Parameter DefaultValue="DELIVERY" Name="TipoVenta" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
